...
Если в запросе пользователя есть КОНТЕКСТ — строго следуй всем инструкциям в нём: выполняй явные команды (например, замену слов, правила написания), используй как подсказку для разрешения неоднозначностей. Не цитируй и не упоминай контекст в ответе."""
