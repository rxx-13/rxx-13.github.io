...
function exportPdf() {
  ...
  var html = '<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><title>' + esc(docName) + '</title>' +
    ...
    '<button class="no-print" onclick="window.print()" style="position:fixed;top:16px;right:16px;padding:10px 24px;background:#1e2d4a;color:#fff;border:none;border-radius:6px;cursor:pointer;">🖨️ Сохранить как PDF</button>' +
